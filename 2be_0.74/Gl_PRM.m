...
Swr=0.25*0;                               %Остаточная вода матрица
Sor=0.2625*0;                             %Остаточная нефть матрица
...
zc=[1e-6,1e-4,1e-3,1e-6,1e-6,1e-6];   % Сжимаемость вода-нефть-газ-песчаник-глина-трещ            
...
fC=[0,0,1];                             %Флаг на трещины верт.тр. - гор.тр. - двойная среда
ddol=0.1;				
drob=50; 
Alp_C=10000;                                % Коэф. обмена вертикальной трещины и пор
