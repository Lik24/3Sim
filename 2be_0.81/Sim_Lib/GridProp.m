function [DATA]=GridProp(wKx,wKy,wKz,wMp,wP,wSw,wSo,wCp,wT,wNTG,CXY,wH,wZ,gXY,nl,WXY,XYgy,GY_subl,Won3)
[nw]=size(wKx,1);
A=zeros(nw,nl*6);
XY=[gXY];
...
%  a=GY.a{l};
 ...
 gSo(:,l)=sub_bond(gSo(:,l),x_y{l},XY,0);   %//////////////
...
DATA.gMp=gMp;
DATA.gP=100.*gP./gP;%+0.001*rand(size(gP));
DATA.gSw=gSw;
DATA.gSo=gSo;       %//////////////////
DATA.gCp=gCp;
DATA.XY=XY;
