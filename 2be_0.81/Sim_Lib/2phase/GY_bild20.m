...
[KWOG_GY.Kfw_xyM,KWOG_GY.Kfo_xyM]=Sat_cal2(SwT,1,as,aw); %water,oil

vP=GY_Pz>=Pi(V.va);
SwT=GY_Swz.*vP+MSw.*(vP==0);

[KWOG_GY.Kfw_zM,KWOG_GY.Kfo_zM]=Sat_cal2(SwT,1,as,aw);
...
[KWOG_GY.Kfw_xyD,KWOG_GY.Kfo_xyD]=Sat_cal2(SwT,1,ts,tw); 

vP=GY_Pz(vad)>=Pi(V.vd);
SwT=GY_Swz(vad).*vP+DSw.*(vP==0);

[KWOG_GY.Kfw_zD,KWOG_GY.Kfo_zD]=Sat_cal2(SwT,1,ts,tw); %water
