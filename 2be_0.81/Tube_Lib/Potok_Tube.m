function [CW,CO,CG,CWCgs,COCgs,CP]=Potok_Tube(C,P,Sw,Cp,PR,fp,kms,L,r,c,n,SGM,CMP)
...
Toa = To.*(SGM.Cor(c).*Rs + SGM.Co(c));
Toa = sparse(r,c,Toa,n,n);     Toa = Toa + Toa';
...
CWCgs = Twa - sparse(1:n,1:n,sum(Twa,2),n,n);
COCgs = Toa - sparse(1:n,1:n,sum(Toa,2),n,n);
