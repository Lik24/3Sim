function [GY,WXY,H,Hk,K,Mp,Sw,So,Z1,Z3,GY_subl,Pw,Qw,Uf,Cpw,PwQC_bnd,Won3]=read_mr_prop_MF1

    mark(1)={'Bond_coord'};  mark(2)={'GY_sub'};     mark(3)={'Ha'};
    mark(4)={'Hk'}; mark(5)={'K'};   mark(6)={'Mp'};
    mark(7)={'Sw'};  mark(8)={'Well_coord2'};   mark(9)={'Z1'}; 
    mark(10)={'Z3'}; 
    mark(11)={'Pw'}; mark(12)={'Qw'}; mark(13)={'well_type'}; mark(14)={'Cpw'}; mark(15)={'So'};
...
A(15)={0.75*ones(1,Nl)};    %  Нефтенасыщенность
...
A(11)={[7300,10,120,120,120,10]};    %  Забойное давление
A(12)={[7300,0,0,100,0,0]};           %  Дебит жидкости
A(13)={[7300,1,0,-1,0,0]};       %  Тип скважины
