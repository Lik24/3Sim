function [WData,Won3]=Well_DATA(WXY,Z,Ta,Nl,dh)
r0=0.084;
...
for j=1:size(uB,1)
    ...
    wxy=WXY(Won3(:,1)==uB(j),:);
    R=((wxy(1,1)-wxy(2,1))^2+(wxy(1,2)-wxy(2,2))^2)^0.5;
    segm=ceil(R/dh);
    dXY=[wxy(1,1)-wxy(2,1),wxy(1,2)-wxy(2,2)]/segm;
