...
A(3)={[10,10,10]};        %  Толшина слоя  
A(4)={[10,10,10]};        %  Толшина коллектора  
A(5)={[1000,1000,1000]};  %  Проницаемость  
A(6)={[0.30,0.30,0.30]};  %  Пористость
A(7)={[0.25,0.25,0.25]};    %  Водонасыщенность
A(9)={[800	810	820;      %  Глубина залегания
       810	820	830;
       810	820	830;
       820	830	840;
       810  810 810]};
A(10)={[800	810	820;      %  Глубина залегания
       810	820	830;
       810	820	830;
       820	830	840;
       810  810 810]};
...
A(8)={[1, 250,   0,   nan, nan;         %Координаты
       2, 0,     500, nan, nan;
       3, 500,   500, nan, nan;
       4, 500,   0, nan, nan;
       5, 250,   500, 250, 350]};

A(11)={[7300,120,100,20,20,20]};    %  Забойное давление
A(12)={[7300,-100,0,0,0,0]};           %  Дебит жидкости
A(13)={[7300,-1,0,0,0,1]};           %  Тип скважины
A(14)={[7300,0,0,0,0,0]};           %  Полимер
