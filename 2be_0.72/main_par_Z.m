...
parfor i=1:5
    SD(i)=par_run(KX,KY,kz{i},Mp,P,Sw,Cp,T,NTG,WXY,H,Z,XY_GY,XY_GY_new,GY_subl,PR);
end
end

function SD=par_run(KX,KY,KZ,Mp,P,Sw,Cp,T,NTG,WXY,H,Z,XY_GY,XY_GY_new,GY_subl,PR)
