function [A2CL,A2CW,A2CO,A2CG,A2CWCgs,A2COCgs]=Obmen_T2M_2(a2c,Pm,Pt,mu,MCp,CCp,r,c,KFA,KFC,SGM)
%KF
   na = size(Pm,1);
   nc = size(Pt,1);
if isempty(r)==0
    ...
    Cgsw = 0.5*(SGM.Cgsw(c) + SGM.Cgsw(r));
    Cgso = 0.5*(SGM.Cgso(c) + SGM.Cgso(r));
