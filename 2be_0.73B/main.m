...
nt={zeros(2,0)};
%nt=elka(1,PR.Nl,DATA.XY,4,20,0,25,[1,3]);  %0/1 - выкл/вкл.; кол-во трещин, длинна, флаг к скважине
%load('nt_s2')
...
%VZL_VORONOI(DATA,Pi(:,end),p,WXY,WData.Uf(:,end),Won3)
